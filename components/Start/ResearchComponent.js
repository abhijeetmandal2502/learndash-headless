        ...
        <>
            ...
            <div className='bg-transparent '>
                <div className='  border-b-2 border-bordergray py-5'>
                    <h2 className='text-[30px] leading-[50px]'>
                        using research
                    ...
                    <div className='flex space-x-5 items-center py-3 '>
                        ...
                        <div className='flex space-x-1  items-center'>
                            ...
                            <h3 className='font-semibold text-[16px] ' >Geal Wood</h3>
                    ...
                    <button className='font-semibold border-b border-black'>
                        show more
                    </button>
                    ...
                    {courseData && courseData.map((item, index) => {
                        return (
                            <div key={index} className='flex items-center space-x-4 py-2'>
                                ...
                                <p className='text-[19px]'>{item}</p>
                            </div>
                        )
                    })}


                    <button className=' border-b border-black font-semibold text-[19px] pt-8'>
