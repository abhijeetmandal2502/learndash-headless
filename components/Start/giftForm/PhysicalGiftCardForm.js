...
const PhysicalGiftCardForm = ({ showPaymentOpt }) => {
        ...
        <>
            ...
            <div className='relative'>
                ...
                <div className='absolute justify-center hidden mx-3 md:flex md:right-5 bottom-5' >
                    ...
                    <button className={`smallf py-1 px-20 text-black  ${styles.formbtnbg} flex items-center space-x-4`}><div className='font-bold'>+ add to :</div> <div className='triplelargef leading-[130%] '>$0</div></button>
                </div>

                {/* total gift and total amount */}
                <div className={`absolute bottom-0 left-0 w-full bg-white flex justify-center py-5 px-2 space-x-2 cursor-pointer ${styles.addgiftCardBtn} `} onClick={() => { showPaymentOpt() }}>
