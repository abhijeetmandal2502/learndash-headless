    ...
    return (
        <>
            ...
            <div className='relative p-6 pb-28'>
                ...
                <div className='bg-[#f2e9ff] p-[16px] max-h-[220px] overflow-scroll'>
                    {giftcardQty.map((item, key) =>
                        <div key={key} className={`grid grid-cols-12 gap-2 `}>
                            <div className='col-span-12 md:col-span-1 dubblelargef'><span className='flex justify-center w-6 h-6 text-sm rounded-full bg-[#e0c9ff] item-center'>1</span></div>
                            <div className='col-span-12 md:col-span-11'>
                ...
                <div className='absolute flex justify-center right-5 bottom-5'>
