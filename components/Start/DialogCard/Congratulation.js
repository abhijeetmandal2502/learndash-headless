    ...
    return (
        <>
            ...
            <div className=' px-5  h-screen md:hidden'>
                <h3 className={`text-center hidden md:block tracking-wider supermediumf  leading-tight md:pb-8 text-black ${styles.congrateTitle}`}>congratulations! <br></br> your course has begun!</h3>
                {/* title for mobile */}
                <h3 className='text-center md:hidden  tracking-wider text-[36px] leading-[110%] md:pb-12 text-black'>Congratulations! Your course has begun!</h3>

                <div className="md:flex md:space-x-5 justify-between">
                    {congrateData && congrateData.map((item, index) => {
                        return (<>
                            <div key={index} className="  md:block flex justify-start  items-center  space-x-2 px-5 " >
                                <div className='mt-3'>
                ...
                <div className={`flex justify-center items-center pt-8 pb-5  ${styles.congfrateContinueBtn}`}>
                    <button className={` px-16 mt-4 py-3 tracking-wide text-white ${styles.submitbtnbg} rounded-3xl text-[17px] traking-[0.02em] focus:outline-none`} type="submit">continue to course
                    </button>
                </div>
