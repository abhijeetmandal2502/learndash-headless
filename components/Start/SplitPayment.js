            ...
            <Image src="/images/eyeIcon.svg" width={22} height={15} alt="show hide password icon" />
                    ...
                    <div className={`max-w-[75%] mx-auto`}>
                        <button type="button"
                            ...
                            onClick={() => { openModal() }}
                            className={`w-full px-4 mt-4 py-2 tracking-[0.02em] text-white  ${styles.paymentbyGiftCardBtn}  rounded-3xl text-[18px] font-semibold traking-[0.02em] focus:outline-none`}  >split payment method
