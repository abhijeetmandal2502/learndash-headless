                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        ...
                        <div className="p-4 bg-white flex flex-col lg:w-full ">
                            ...
                            <div className="">
                                ...
                                <input className="border border-bordergray p-4 rounded w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="email" />
                            </div>
                            ...
                            <div className="mt-4 flex-col">
                                <div>
                                    ...
                                    <input className="border rounded-tl  border-bordergray p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="email" placeholder="**** **** **** *****" />
                                </div>
                                <div className="flex-row flex mt-5 space-x-5">
                                    <div>
                                        <label className="mt-8 mb-1.5 text-base leading-4 font-bold">exp. date</label>
                                        <input className="border rounded-bl border-bordergray p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="email" placeholder="MM/YY" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input className="border rounded-bl  border-bordergray p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="text" />
                                    </div>
                                </div>
                            ...
                            <button className="w-full px-4 mt-4 py-4 tracking-wide text-white transition-colors duration-200 transform bg-black hover:bg-voilet rounded-3xl text-[18px] font-semibold traking-[0.02em] focus:outline-none" type="submit">start course! $40.00
