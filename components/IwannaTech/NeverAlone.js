            ...
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                ...
                <div className='col-span-12 md:col-span-5 flex justify-center items-center'>
                    <div>
                        ...
                        <p className='text-white font-bold xl:text-[18px] 3xl:xl:text-[26px] lg:text-[16px] text-[18px] pt-5'>We are right here every step of the way to help you create the course you want on our e-learning platform! Just contact your concierge and they’ll walk you through any part of the course process you need!</p>
