            ...
            <div className={`bg-transparent grid grid-cols-12  ${direction == "up" ? styles.fadeAnimation : styles.fadeAnimationDown}`}>
                ...
                <div className='flex items-start mt-[8%] justify-center col-span-12 md:col-span-5'>
                    <div>
                        ...
                        <p className='pt-5  xl:max-w-[90%] font-[450] leading-[130%] 2xl:leading-[120%] text-white lowercase largef'>We are right here every step of the way to help you create the course you want on our e-learning platform! Just contact your concierge and they’ll walk you through any part of the course process you need!</p>
                    </div>
                </div>
