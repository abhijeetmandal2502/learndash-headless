            ...
            <div className={`bg-transparent grid grid-cols-12 ${direction == "up" ? styles.fadeAnimation : styles.fadeAnimationDown}`}>
                ...
                <div className='flex justify-center md:justify-start col-span-12 md:col-span-5 items-strat'>
                    <div>
                        ...
                        <p className='font-[450] lowercase leading-[130%] 2xl:leading-[120%] text-white  xl:max-w-[90%] largef md:pt-5'>But it seems just over the last few years, Online Continuing Education has exploded thanks to improved tech, and increased concerns for social distancing!
                            <br></br><br></br>
