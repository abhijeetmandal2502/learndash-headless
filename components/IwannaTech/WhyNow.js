        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                ...
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-semibold fourxllargef  ${styles.shadow} xl:leading-[80px] leading-[20px] md:leading-[50px]  tracking-wide`}>why now?</h2>
                        <h4 className=' leading-10 dubblelargef font-bold 2xl:pt-10 pt-5 pb-4'>we ve been <br></br> here 15 years !</h4>
                        <p className='text-white font-bold smallf md:pt-5'>But it seems just over the last few years, Online Continuing Education has exploded thanks to improved tech, and increased concerns for social distancing!
                            <br></br><br></br>
