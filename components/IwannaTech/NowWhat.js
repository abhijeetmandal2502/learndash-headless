        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-semibold xl:text-[65px] lg:text-[50px] md:text-[40px] text-[40px]  ${styles.shadow} leading-[80px] lg:leading-[40px] xl:leading-[80px] tracking-wide`}>Now what?</h2>
                        <h4 className='xl:text-[45px] lg:text-[30px] text-[30px]  font-bold py-4 leading-[40px]'>now we enter<br></br>contact:</h4>
                ...
                <div className='col-span-12 md:col-span-7 flex justify-center items-start xl:-mt-32 lg:-mt-24'>
