        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-[600] xl:text-[62px] lg:text-[40px] text-[45px] ${styles.shadow} xl:leading-[70px]  lg:leading-[50px] leading-[50px]  tracking-wide`}>are both you <span className='border-b-4'>and</span> your course ncbtmb approved?</h2>
                        ...
                        <h4 className='xl:text-[35px] lg:text-[25px] font-bold xl:py-4 lg:py-4 py-4'>That’s kind of a big deal</h4>
                        <p className='text-white font-bold xl:text-[18px] lg:text-[16px] xl:pt-5 lg:pt-0 py-4'> Compliance requires both Provider and Course to be pre-approved.</p>
