        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}   `}>
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-semibold 2xl:text-[65px]  md:text-[40px] text-[40px]  ${styles.shadow} leading-[80px] md:leading-[60px] 2xl:leading-[80px] tracking-wide`}>ready to get started? </h2>
                        ...
                        <p className='text-white font-bold text-[18px] md:text-[16px] 2xl:text-[19px] tracking-wide pt-5'> Your time has come! Make it happen!</p>

                    </div>
                </div>

                <div className={`relative col-span-12 md:col-span-7 h-[100vh] 2xl:block md:hidden ${loading ? styles.tranatationNone : 'opacity-0'} mt-5 `}>
