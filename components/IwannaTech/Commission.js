        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 xl:gap-20 lg:gap-10 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-6 flex justify-center items-strat'>
                    <div className='ml-20'>
                        <h2 className={`text-white font-semibold xl:text-[65px] lg:text-[50px] md:text-[40px] text-[40px]  ${styles.shadow} leading-[80px] lg:leading-[40px] xl:leading-[80px] tracking-wide`}>commission</h2>
                        ...
                        <p className='text-white font-bold text-[18px] lg:text-[16px] xl:text-[18px] pt-5'>earning are split 50/50 and you are paid once a month, forever!</p>
                ...
                <div className='col-span-12 md:col-span-6 '>
                    ...
                    <p className='mt-5 px-16 text-white text-[19px] lg:text-[16px] xl:text-[19px]'>…And you can check on your course’s progress and edit your course anytime on our realtime dashboard!</p>
                </div>
