            ...
            <div className={`bg-transparent grid grid-cols-12 xl:gap-20 lg:gap-10 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-6 flex justify-center items-strat'>
                    <div className='md:ml-20 md:mt-0 mt-5'>
                        ...
                        <p className='text-white font-bold text-[14px] md:text-[16px] 2xl:text-[18px] 3xl:text-[28px] pt-5'>earning are split 50/50 and you are paid once a month, forever!</p>
                ...
                <div className='col-span-12 md:col-span-6 '>
                    ...
                    <p className='md:mt-5 md:px-16 text-white text-[14px] md:text-[16px] 2xl:text-[19px] 3xl:text-[30px]'>…And you can check on your course’s progress and edit your course anytime on our realtime dashboard!</p>
                </div>
