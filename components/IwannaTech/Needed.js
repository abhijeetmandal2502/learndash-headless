        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-semibold 2xl:text-[70px] 3xl:text-[100px] 4xl:text-[120px] lg:text-[50px] md:text-[40px] text-[40px] ${styles.shadow} 2xl:leading-[80px] 3xl:leading-[100px] 4xl:leading-[100px] lg:leading-[60px]  tracking-wide`}>what’s needed?</h2>

                        {/* <Image src="/images/WhiteLogo.svg" width="350" height="250" alt="tech logo" /> */}
                        <p className='text-white font-bold 2xl:text-[18px] 3xl:text-[28px] 4xl:text-[35px] md:text-[16px] text-[16px] pt-5'> Both you AND your course need to already be approved by NCBTMB
