        ...
        <>
            <div className={`bg-transparent grid grid-cols-12 ${styles.fadeAnimation}`}>
                <div className='col-span-12 md:col-span-5 flex justify-center items-strat'>
                    <div>
                        <h2 className={`text-white font-semibold 2xl:text-[65px] 3xl:text-[95px] 4xl:text-[120px] xl:text-[50px]  md:text-[40px] text-[40px]  ${styles.shadow} leading-[80px] xl:leading-[80px] 3xl:leading-[110px] 4xl:leading-[120px] lg:leading-[40px] tracking-wide`}>start creating</h2>
                        <p className='text-white font-bold text-[18px] 2xl:text-[18px] 3xl:text-[24px] md:text-[16px] lg:leading-[25px]
