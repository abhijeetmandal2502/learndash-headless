            ...
            <div className={`bg-transparent grid grid-cols-12 ${direction == "up" ? styles.fadeAnimation : styles.fadeAnimationDown}`}>
                ...
                <div className='flex justify-center col-span-12 md:col-span-5 items-strat'>
                    <div>
                        ...
                        <p className='pt-5 font-[450] lowercase leading-[130%] 2xl:leading-[120%] text-white 2xl:pt-10 2xl:tracking-wide  largef'>follow our easy step-by-step template to get your course organized for proper online structuring. then jump in and create your masterpiece!</p>
