            ...
            {step1 ?
                <div>
                    <div className='flex justify-between pb-5 '>
                        <button className=' font-normal py-2 pb-4' onClick={() => HideForgetPasswordModel()}>
                            <div className='flex justify-center items-center space-x-2'>
                                ...
                                <span className='font-semibold 3xl:text-[30px]'>Back to login</span>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className='flex  items-center space-x-2'>
                        <div className=' border-b-4 text-left w-[33%] text-lg 3xl:text-3xl border-voilet text-voilet'>step1</div>
                        <div className=' border-b-4 text-left w-[33%] text-lg 3xl:text-3xl border-bodergray text-gray'>step2</div>
                        <div className=' border-b-4 text-left w-[33%] text-lg 3xl:text-3xl border-bodergray text-gray'>step3</div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit((data) => console.log('data', data))}>
                        ...
                        <button className="w-full px-4 mt-4 3xl:mt-8 py-2 3xl:py-5 3xl:text-3xl mb-5 tracking-wide text-white transition-colors duration-200 transform bg-black hover:bg-voilet rounded-3xl focus:outline-none" type="submit" onClick={() => { HandleStep1() }}>next
