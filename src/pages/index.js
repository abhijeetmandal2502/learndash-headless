...
const Test = () => {
    ...
    return (
        <>
            ...
            <Head> LearnDash </Head>
            <div className={`grid grid-cols-1 md:grid-cols-2   md:h-screen bg-[url('/images/bg-image.png')] bg-cover bg-center bg-no-repeat`}>
                ...
                {!open ? <div className='grid grid-cols-1 relative md:divide-x-[1px] md:divide-bordergray md:grid-cols-7
                 '>
                    <div className='col-span-7 md:h-screen md:col-span-3'>
                        <div className='grid md:h-full grid-cols-1 divide-y-[1px] divide-bordergray md:border-0 border-y-[1px] border-bordergray'>
                            ...
                            <div className='flex flex-col justify-center p-2 zoom-effect-container border-l border-l-bordergray' onClick={() => setOpen(true)}>
                    ...
                    <div className='col-span-7 p-4 md:col-span-1 relative h-screen w-full'>
                ...
                {open ?
                    <div className=" relative grid grid-cols-12  z-40">
                        ...
                        <div className='col-span-12 md:col-span-2 mt-5'>
